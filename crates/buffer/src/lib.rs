...
## Stay Connected
- Follow updates on [X](https://pinote.org/x).
- Join the community and chat on [Discord](https://pinote.org/discord). 

# Participants:

* [John Jeong](mailto:john@pinote.org)
* [Yujong Lee](mailto:yujonglee@pinote.org)
...
"#;
    ...
    fn test_md_to_md_4() {
        let input = r#"
# Pinote: Enhanced Meeting Notes

# Objective: Introduce Pinote as a smart notepad for enhanced meeting productivity.
...
# Stay Connected: Promote Pinote through X and Discord.
...
# Further Information: Follow updates on [X](https://pinote.org/x) and [Discord](https://pinote.org/discord).
        "#;

        insta::assert_snapshot!(md_to_md(input).unwrap().to_string(), @"# Further Information: Follow updates on [X](https://pinote.org/x) and [Discord](https://pinote.org/discord).");
    }
...
"#;
        ...
        <ul>
        <li>Follow updates on <a href="https://pinote.org/x">X</a>.</li>
        <li>Join the community and chat on <a href="https://pinote.org/discord">Discord</a>.</li>
        </ul>
        "###);
    }
